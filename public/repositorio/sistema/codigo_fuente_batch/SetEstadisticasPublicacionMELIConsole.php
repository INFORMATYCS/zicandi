...
Console::log('ZICANDI Calculando estadisticas para publicaciones MELI', 'white', true, 'green', $logFisico);
...
foreach ($cuentas as $cuenta){
    ...
    if($publicaciones->httpCode==200){
        ...
        foreach ($fragmentos as $bloque){
            ...
            $resp = json_decode(Restfull::sendGet(Param::$_BASE_PATH_API.'zicandi/public/tienda/calculaEstadisticasPublicacion?idCuentaTienda='.$idCuentaTienda.'&publicaciones20='.$cadenaProcesa));
